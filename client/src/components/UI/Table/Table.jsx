...
export const Table = ({ locationData, handleMarker, setFavLists, setShowNotif, setNotifText }) => {
	...
	const handleSingleSearch = (rowData) => {
		return (
			<Button
				variant='outlined'
				onClick={() => handleMarker(rowData._id, rowData.lat, rowData.long, rowData.lname)}>
				Search
			</Button>
		);
	};
